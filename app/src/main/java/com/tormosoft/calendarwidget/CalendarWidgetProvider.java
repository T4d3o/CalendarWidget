...
public class CalendarWidgetProvider extends AppWidgetProvider {
    ...
    private static final String ACTION_PREVIOUS_MONTH =
            "com.example.calendarwidget.ACTION_PREVIOUS_MONTH";
    private static final String ACTION_NEXT_MONTH = "com.example.calendarwidget.ACTION_NEXT_MONTH";
    private static final String ACTION_TODAY = "com.example.calendarwidget.ACTION_TODAY";
    private static final String ACTION_DATE_CLICK = "com.example.calendarwidget.ACTION_DATE_CLICK";

    private static final String EXTRA_YEAR = "com.example.calendarwidget.EXTRA_YEAR";
    private static final String EXTRA_MONTH = "com.example.calendarwidget.EXTRA_MONTH";
    private static final String EXTRA_DATE = "com.example.calendarwidget.EXTRA_DATE";

    private static final String PREFERENCE_FILE =
            "com.example.calendarwidget.PREFERENCE_WIDGET_";
    ...
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager,
        ...
        render(context, appWidgetId, getTheme(context), getWeekStartDay(context), getWeekendHighlight(context));
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        int weekendHighlight = getWeekendHighlight(context);

        for (int appWidgetId: appWidgetIds) {
            render(context, appWidgetId, theme, weekStartDay, weekendHighlight);
        }
    }
    ...
    private int getWeekendHighlight(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
