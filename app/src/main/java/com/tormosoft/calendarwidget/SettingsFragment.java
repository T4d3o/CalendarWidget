...
public class SettingsFragment extends PreferenceFragment
    ...
    private HashMap<String, String> mWeekEndHighlightReverseLookup;
    ...
    public static final String PREF_WEEKEND_HIGHLIGHT = "weekend_highlight";
    ...
    public void onAttach(Activity activity) {
        ...
        mWeekEndHighlightReverseLookup = createReverseLookup(
                mResources, R.array.weekend_highlight, R.array.weekend_highlight_values);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setSummary(prefMgr, sharedPref, mWeekEndHighlightReverseLookup, PREF_WEEKEND_HIGHLIGHT);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPref, String key) {
        ...
        } else if (key.equals(PREF_WEEKEND_HIGHLIGHT)) {
            setSummary(prefMgr, sharedPref, mWeekEndHighlightReverseLookup, key);
